...
* Required Text: Fundamentals of Database Systems, 7th edition, Elmasri & Navathe, Addison-Wesley, 2015. [Sixth edition is OK to use. Please make sure to consult the right chapters. See Correspondence Table below.]
    ...
    | Topic                                    | 7ed | 6ed |
    |------------------------------------------|-----|-----|
    | Databases and Users                      |  1  |  1  |
    | Database Concepts                        |  2  |  2  |
    | ER Models                                |  3  |  7  |
    | EER Models                               |  4  |  8  |
    | Relational Data Model                    |  5  |  3  |
    | Basic SQL                                |  6  |  4  |
    | Advanced SQL                             |  7  |  5  |
    | Relational Algebra and Calculus          |  8  |  6  |
    | EER-Relational Mapping                   |  9  |  9  |
    | Functional Dependencies and Normal Forms | 14  | 15  |
    | Database Design Algorithms               | 15  | 16  |
    | Storage Structures                       | 16  | 17  |
    | Indexing Structures                      | 17  | 18  |
